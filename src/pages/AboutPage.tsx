  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <section className="bg-white p-8 rounded-xl shadow-lg">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Platformumuz</h2>
      ...
      {/* Misyon */}
      <section className="bg-gradient-to-br from-primary-50 to-primary-100 p-8 rounded-xl shadow-lg border border-primary-200">
      ...
      {/* Sorunlar */}
      <section className="bg-white p-8 rounded-xl shadow-lg">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Karşılaştığımız Sorunlar</h2>
      ...
      <section className="bg-gradient-to-br from-primary-50 to-primary-100 p-8 rounded-xl shadow-lg border border-primary-200">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Topluluk ve Dayanışma</h2>
        <div className="prose prose-lg text-gray-700 space-y-4">
          <p>
      ...
      {/* Hedefler */}
      <section className="bg-white p-8 rounded-xl shadow-lg">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Hedeflerimiz</h2>
      ...
      {/* CTA */}
      <section className="bg-gradient-to-br from-primary-600 to-primary-700 p-8 rounded-xl shadow-lg text-center text-white">
